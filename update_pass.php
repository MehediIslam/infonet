  ...
  <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
	...
	<script>
		...
		function chk()
		{
			...
			var current_pass = document.getElementById('current').value;
			var new_pass = document.getElementById('new').value;
			var renew_pass = document.getElementById('renew').value;
			
			var dataString = 'login_id=' + login_id + '&current=' + current_pass + '&new=' + new_pass + '&renew=' + renew_pass;
                         ...
                         <div class="panel-body" style="padding-bottom:15px;">
                          <div class="col-md-12">
                           ...
                           <form id="myForm">
							...
							<div class="form-group"><label class="col-sm-4 control-label text-left">Current Password</label>
                              <div class="col-sm-8"><input id="current" type="password" class="form-control"></div>
                            </div>
							
							<div class="form-group"><label class="col-sm-4 control-label text-left">New Password</label>
                              <div class="col-sm-8"><input id="new" type="password" class="form-control"></div>
                            </div>
							
							<div class="form-group"><label class="col-sm-4 control-label text-left">Confirm New Password</label>
                              <div class="col-sm-8"><input id="renew" type="password" class="form-control"></div>
                            </div>
