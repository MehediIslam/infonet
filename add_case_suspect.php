  ...
  <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
	...
	<script>
		...
		function chk()
		{
			...
			var dataString = 'suspect_id='+ suspect_id + '&case_id='+ case_id + '&username='+ username;
		...
		function chk2()
		{
			...
			var dataString = 'case_id=' + case_id + '&login_id=' + login_id + '&real_name=' + real_name + '&asl=' + asl + '&main_id=' + main_id + '&altid=' + altid + '&evidence=' + evidence + '&description=' + description + '&username='+ username;
            ...
            <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Case: <?php echo $case_name; ?></h3>
                ...
                <div class="form-element">
                  <div class="col-md-12 padding-0">
                      ...
                      <div class="panel form-element-padding">
                        <div class="panel-heading">
                         ...
                         <div class="panel-body" style="padding-bottom:15px;">
                          <div class="col-md-12">
						  <p class="cusP" id="msg2"></p>
                           <form id="myForm">
                            <div class="form-group"><label class="col-sm-2 control-label text-right">Real Name</label>
                              <div class="col-sm-10"><input id="real_name" type="text" class="form-control android"></div>
                            </div>
							
							<div class="form-group"><label class="col-sm-2 control-label text-right">ASL</label>
                              <div class="col-sm-10"><input id="asl" type="text" class="form-control" placeholder="age, sex, location"></div>
                            </div>
							
							<div class="form-group"><label class="col-sm-2 control-label text-right">Main ID</label>
                              <div class="col-sm-10"><input required id="main_id" type="text" class="form-control" placeholder="ToLife UserId"></div>
                            </div>
							
							<div class="form-group"><label class="col-sm-2 control-label text-right">Alternate IDs</label>
                              <div class="col-sm-10"><input type="text" id="altid" class="form-control" placeholder="fake_id1, fake_id2"></div>
                            </div>
							
							<div class="form-group"><label class="col-sm-2 control-label text-right">Evidence</label>
                              <div class="col-sm-10"><input type="text" id="evidence" class="form-control" placeholder="https://drive.google.com/drive/folders/"></div>
                            </div>
                          
							<div class="form-group"><label class="col-sm-2 control-label text-right">Description</label>
                              <div class="col-sm-10"><textarea id="description" placeholder="write a short description against this user.." class="form-control android"></textarea></div>
                            </div>
							
							<div class="form-group"><label class="col-sm-9 control-label text-right"></label>
                              <div class="col-sm-3" style="margin-top:15px;">
							  <button class="btn ripple btn-gradient btn-info" type="submit" value="submit" onclick="return chk2()">
                                    <div>
                                      <span>Add</span>
                                    </div>
                                  </button>
					...
					<div class="col-md-4">
                      <div class="panel form-element-padding">
                        <div class="panel-heading">
                         <h4>Existing Suspect</h4>
                        </div>
                        <div class="panel-body" style="padding-bottom:15px;">
                        <div class="col-md-12"> 
						<div><p class="cusP" id="msg"></p> </div>
						<form>
							<select id="suspect_id" class="select2-A">
							<optgroup label="Suspect from Database">
							  <?php
								   $sql1 = "SELECT * FROM `suspect` WHERE 1";
								   $result3=$conn->query($sql1);
								   while($row1=$result3->fetch_assoc())
								   {
										echo "<option value='".$row1['suspect_id']."'>".$row1['main_id']."</option>" ;
								   } 
							   ?>
							  </optgroup>          
							</select>
							<button class="cus_button" type="submit" value="submit" onclick="return chk()">Turn in</button>
						</form> 
						</div>  
