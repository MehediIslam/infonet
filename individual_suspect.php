  ...
  <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
	...
	<script>
		...
		function chk()
		{
			...
			var dataString = 'login_id=' + login_id + '&real_name=' + real_name + '&asl=' + asl + '&main_id=' + main_id + '&altid=' + altid + '&evidence=' + evidence + '&description=' + description;
            ...
            <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Individual Suspect</h3>
