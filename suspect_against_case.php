          ...
          <div class="notifications-wrapper">
            <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-4">
						<h3 class="animated fadeInLeft">Add Suspects</h3>
                    </div>
                  </div>
            </div>
                    ...
                    <div class="panel-body">
						...
						<?php
						   ...
						   while($row1=$result1->fetch_assoc())
						   {
							 if($row1['status'] == 1){
						?>
						<?php echo "<a href=\"add_case_suspect.php?case_id=$row1[case_id]\" style='color:inherit; font-weight: normal;'>" ?>
