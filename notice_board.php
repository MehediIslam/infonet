...
if(isset($_POST["send"])) {
	...
	$sql = "INSERT INTO `notice_board`(`login_id`, `notice`, `date`, `day`) VALUES ('$login_id','$notice','$date_time','$day')";
          ...
          <div id="content">
            <div class="col-md-12 padding-0">
              <div class="col-md-12 padding-0">
                ...
                <div class="col-md-8">
				<form method="post" action="notice_board.php" enctype="multipart/form-data">
                  <div class="box-v5 panel">
                    <div class="panel-heading padding-0 bg-white border-none">
                        <textarea required name="notice" placeholder="what do you think?"></textarea>
                    </div>
                    <div class="panel-body">
                      <div class="col-md-12 padding-0">
                     ...
                     <!--     <a href="#">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6 padding-0">
                          <button class="btn btn-round pull-right" name="send">
                            <span>SEND</span>
				...
				<?php
				   $sql1 = "SELECT notice_board.notice_id ,login.username, notice_board.notice, notice_board.date, notice_board.day FROM `notice_board` INNER JOIN `login` ON login.login_id = notice_board.login_id ORDER BY STR_TO_DATE(notice_board.`date`,'%Y-%m-%d %h:%i:%s') DESC";
				   $result1=$conn->query($sql1);
				   while($row1=$result1->fetch_assoc())
				   {	   
				?>
                <div class="panel box-v6">
                     <div class="panel-heading" style="padding-bottom:0;padding-top:.5px;">
                       <h4><?php echo $row1['username']; ?>
                <!--   <span class="icon-options-vertical icons pull-right"></span>  -->
					   
					   <div class="btn-group right">
							<span class="icon-options-vertical icons pull-right" data-toggle="dropdown">
							</span>
							<ul class="dropdown-menu" role="menu">
							  <li><?php echo "<a href=\"notice_board.php?notice_id=$row1[notice_id]\">" ?>Delete</a></li>
							</ul>
						  </div>
                      </h4>
                    ...
                    <div class="panel-body padding-0">
                      <div class="col-md-12 padding-0">
                          <div class="col-md-12 padding-0" style="height:auto;">
                            <div class="col-md-12 col-sm-12 col-xs-12 padding-0 box-v6-content">
                              <div class="col-md-10 col-sm-10 col-xs-10">
                                <h5><?php echo $row1['notice']; ?></h5>
								<br>
                                <p class="cus_p"><?php echo date("D", strtotime($row1['day'])); ?>, <?php echo date("d F Y", strtotime($row1['date'])); ?></p>
                              </div>
                            </div>
                          </div>
                      </div>
                  ...
                  <div class="panel">
                      ...
                      <div class="panel-body">
                        <div class="col-md-12 responsive-table">
                            <table class="table table-hover cus_table">
							<?php
							   $sql = "SELECT `login_id`,`username`, `user_type` FROM `login`";
							   $result2=$conn->query($sql);
							   while($row2=$result2->fetch_assoc())
							   {	   
							?>
							  <tr>
								<td><?php if($login_id==$row2['login_id']){echo '<b style="color:#28ed0e">'.$row2['username'].'</b>';} else{echo $row2['username'];}?></td>
								<td align="right">
								  <span class="label label-danger"><?php if($row2['user_type']=='SA'){echo "SYSTEM ADMIN";};?></span>
								  <span class="label label-danger"><?php if($row2['user_type']=='A'){echo "ADMIN";};?></span>
								  <span class="label label-success"><?php if($row2['user_type']=='M'){echo "MODERATOR";};?></span>
								  <span class="label label-primary"><?php if($row2['user_type']=='G'){echo "GUEST";};?></span>
								</td>
							  </tr> 
							<?php }?>                   
                            </table>
