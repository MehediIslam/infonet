...
//fetching selected suspect information
$suspect_id = $_GET['suspect_id'];
$select1 = "SELECT * FROM `suspect` WHERE `suspect_id` = $suspect_id";
  ...
  <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
	...
	<script>
		...
		function chk()
		{
			...
			var suspect_id = "<?php echo $suspect_id; ?>";
			var info = document.getElementById('info').value;
			
			var dataString = 'login_id=' + login_id + '&suspect_id=' + suspect_id + '&info=' + info;
            ...
            <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Add Information</h3>
                         ...
                         <div class="panel-body" style="padding-bottom:15px;">
                          <div class="col-md-12">
                           ...
                           <form id="myForm">
							...
							<div class="form-group"><label class="col-sm-2 control-label text-right">Information</label>
                              <div class="col-sm-10"><textarea id="info" placeholder="provide your information as much you can.." class="form-control android"></textarea></div>
                            </div>
